...
// 실행 결과 => A,B,C 동시에 실행, 종료는 delay짧은 순서대로, 모두 종료되는 데 걸리는 시간(7초 - 가장 delay긴 함수의 종료시간만큼 소요)
// TaskAll: 0.798ms
// [task C]: -10
// [task B]: 2
// [task A]: 11
...
// 실행 결과  => 순서대로 A,B,C가 실행됨(ex1과 다르게 동시 실행X, 앞 선 함수가 실행 완료되야 그 안의 콜백이 실행됨,모든 함수 실행 종료되기까지 7+5+3초 만큼 걸림,모든 딜레이의 누적합만큼 소요)
// [resA]: 13
// [resB]: 26
// [resC]: -260
